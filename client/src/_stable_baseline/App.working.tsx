...
import { AuthStateSimulator } from "@/components/debug/AuthStateSimulator";
...
function Router() {
  console.log("🔁 useAuth() hook triggered in Router");
  const { isLoading, isUserReady, debugAuthState } = useAuth();
  ...
  return (
    <Switch>
      ...
      <Route path="/auth-debug" component={() => <AuthStateSimulator />} />
  ...
  return (
    <ThemeProvider attribute="class" defaultTheme="light">
      <QueryClientProvider client={queryClient}>
        <AuthProvider>
          {(() => {
            console.log("✅ AuthProvider wrapper mounted");
            return null;
          })()}
          <TooltipProvider>
            <Toaster />
